// ===============================
// FSM-LITE Main Logic - VERBOSE VERSION
// ===============================
//
// This version includes extensive inline comments and verbose output 
// to assist in understanding and debugging the FSM-lite workflow.
